...
namespace MD.Logger
{
    public static class LogExtensions
    {
        ...
        public static void WriteLogAsync(this LogServiceClient client, string message, DateTime? timeStamp = null
            ...
            , string action = "", string accountId = ""
        ...
        {
            var ipAddresses = "";
            var IpArray = System.Net.Dns.GetHostAddresses("");      // "" 代表本机
            Array.ForEach(IpArray, ip =>
            {
                ipAddresses += ";" + ip;
            });
            return ipAddresses; // Dns.GetHostAddresses(Dns.GetHostName())[0].ToString();
        }
        #endregion
